...
void* e_realloc ( void* ptr, size_t new_size ) {
	...
	if ( ptr == NULL )
		return e_malloc( new_size );

	size_t size = GET_INUSE_HEADER( ((char*)ptr) - memory - INUSE_HEADER_SIZE )->size;

	if ( new_size <= size )
		return ptr;

	void* new_ptr = e_malloc( new_size );
...
void print_memory_data () {
	...
	printf( "\n" );
	printf( "MAX_MEMORY_IN_MB: %d\n", MAX_MEMORY_IN_MB );
	printf( "MAX_MEMORY: %d\n", MAX_MEMORY );
	printf( "BIN_NUMBER: %d\n", BIN_NUMBER );
	printf( "BIN_TABLE_SIZE: %d\n", BIN_TABLE_SIZE );
	printf( "BIN_TABLE_START: %d\n", BIN_TABLE_START );
	printf( "BIN_TABLE_END: %d\n", BIN_TABLE_END );
	printf( "MEMORY_START: %d\n", MEMORY_START );
	printf( "MEMORY_END: %d\n", MEMORY_END );
	printf( "FREE_HEADER_SIZE: %d\n", FREE_HEADER_SIZE );
	printf( "INUSE_HEADER_SIZE: %d\n", INUSE_HEADER_SIZE );
	printf( "FOOTER_SIZE: %d\n", FOOTER_SIZE );
